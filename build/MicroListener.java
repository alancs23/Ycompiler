...
public interface MicroListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterFor_stmt(@NotNull MicroParser.For_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#for_stmt}.
	 * @param ctx the parse tree
	 */
	void exitFor_stmt(@NotNull MicroParser.For_stmtContext ctx);

	/**
	 * Enter a parse tree produced by {@link MicroParser#decl_list}.
	 * @param ctx the parse tree
	 */
	void enterDecl_list(@NotNull MicroParser.Decl_listContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#decl_list}.
	 * @param ctx the parse tree
	 */
	void exitDecl_list(@NotNull MicroParser.Decl_listContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#break_stmt}.
	 * @param ctx the parse tree
	 */
	void enterBreak_stmt(@NotNull MicroParser.Break_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#break_stmt}.
	 * @param ctx the parse tree
	 */
	void exitBreak_stmt(@NotNull MicroParser.Break_stmtContext ctx);
	...
	/**
	 * Enter a parse tree produced by {@link MicroParser#continue_stmt}.
	 * @param ctx the parse tree
	 */
	void enterContinue_stmt(@NotNull MicroParser.Continue_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link MicroParser#continue_stmt}.
	 * @param ctx the parse tree
	 */
	void exitContinue_stmt(@NotNull MicroParser.Continue_stmtContext ctx);
